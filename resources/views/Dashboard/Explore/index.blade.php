...
@section('main')
    <div class="p-4">
        <div class="flex justify-end">
            <a href="{{ route('dashboard.explores.create') }}"
                    ...
                    @foreach ($explores as $item)
                        <tr class="border-b">
                            ...
                            <td class="flex gap-4 items-center justify-center py-2 px-4">
                                <a href="{{ route('dashboard.explores.edit', ['explore' => $item->id]) }}"
                                    class="text-blue-600 font-bold">Edit</a>
                                <form action="{{ route('dashboard.explores.destroy', ['explore' => $item->id]) }}" method="post">
                                    @csrf
                                    @method('delete')
