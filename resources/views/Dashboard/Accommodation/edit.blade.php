...
@section('main')
    <form action="{{ route('dashboard.accommodations.update', ['accommodation' => $accommodation->id]) }}" method="post"
        ...
        <div class="grid gap-4 p-4">
            <div>
                ...
                <input type="text" id="title" name="title" value="{{ $accommodation->title }}"
            ...
            <div>
                <label for="room_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Số
                    phòng</label>
                <input type="text" name="room_number" id="room_number" value="{{ $accommodation->room_number }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            </div>
            <div>
                <label for="area" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Diện tích</label>
                <input type="text" name="area" id="area" value="{{ $accommodation->area }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            </div>
            <div>
                <label for="bed_size" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kích thước
                    giường</label>
                <input type="text" name="bed_size" id="bed_size" value="{{ $accommodation->bed_size }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            </div>
            <div>
                <label for="address" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Địa chỉ</label>
                <input type="text" name="address" id="address" value="{{ $accommodation->address }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
            </div>
            <div>
